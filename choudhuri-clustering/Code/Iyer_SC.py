...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct  9 23:30:31 2022
...
clustering = SpectralClustering(n_clusters=14, assign_labels="discretize", random_state=0).fit(dims)
...
# affinity_matrix = getAffinityMatrix(dims, k = 11)
...
# affinity_matrix = getAffinityMatrix(dims, k = 14)
